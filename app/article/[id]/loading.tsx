...
export default function ArticleLoading() {
  return (
    <div
      className="min-h-screen bg-[var(--surface)] text-[var(--text-primary)] pb-16 overflow-x-hidden"
      aria-busy="true"
      ...
      <div className="container mx-auto max-w-[1400px] px-4 sm:px-6 py-6 md:py-8">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_350px] gap-8 items-start min-w-0 max-w-full">
          ...
          <div className="space-y-6 min-w-0 max-w-full">
            ...
            <div className="bg-card rounded-xl border border-[var(--border)] p-4 sm:p-5 shadow-xs space-y-4 min-w-0 max-w-full">
