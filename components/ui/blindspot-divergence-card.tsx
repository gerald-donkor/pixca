  ...
  useGSAP(
    () => {
      ...
      mm.add("(prefers-reduced-motion: reduce)", () => {
        gsap.set(".tab-content-panel", { autoAlpha: 1, y: 0 });
      });
    },
        ...
        <div className="flex flex-wrap items-center gap-2.5 self-start sm:self-auto shrink-0">
          ...
          >
            <button
              role="tab"
              type="button"
              id="blindspot-tab-side-by-side"
              aria-selected={activeTab === "side-by-side"}
              aria-controls="blindspot-panel-side-by-side"
            ...
            <button
              role="tab"
              type="button"
              id="blindspot-tab-framing-matrix"
              aria-selected={activeTab === "framing-matrix"}
              aria-controls="blindspot-panel-framing-matrix"
